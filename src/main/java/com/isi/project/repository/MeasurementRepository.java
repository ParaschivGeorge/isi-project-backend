...
public interface MeasurementRepository  extends CrudRepository<Measurement, Long> {
    ...
    @Query("select m from Measurement m where m.type = :type and m.time <= :time order by m.time asc")
    ...
    List<Measurement> findAllByTimeGreaterThan(@Param("time") Integer time);
}
